# Collect audio files from Free Music Archive,
# 'https://freemusicarchive.org/' 

# url_target = 'https://freemusicarchive.org/'
...
def main():
  ...
  parser.add_argument('--target_url', default='https://freemusicarchive.org/genre/Instrumental/')
  parser.add_argument('--max_files', default=10)
  parser.add_argument('--output_dir', default='../GitOutbox/audio_music')
